        ...
        do {
            ...
            switch (opt) {
                ...
                case 1 -> {
                    ...
                    if (settings.getUsersCount() < settings.getUsersSize()) {
                        switch (newKindOpt) {
                            case 1 -> {
                                newUser = new Student();
                        ...
                        System.out.println("Almacenamiento maximo de usuarios alcanzado");
                    }
                }
                ...
                case 3 -> {
                    ...
                    newKindOpt = Prompt.forNumber(scanner, "Elija una opcion del menu: ");
                    switch (newKindOpt) {
                        case 1 -> {
